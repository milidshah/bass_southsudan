...
matching_columns <- grep("^Q9.8.1", names(sudan_v2_df), value = TRUE)
...
sudan_v2_df |>
  ...
  mutate(percentage = answers / sum(answers) * 100) |> # Calculate percentage of total responses
...
sudan_v2_df |>
  ...
  slice_max(answers, n = 1, with_ties = FALSE) |> # Pick the most frequent response
  mutate(percentage = answers / sum(answers) * 100) |>  # Calculate percentage of total responses per county
